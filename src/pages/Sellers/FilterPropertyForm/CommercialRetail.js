...
import PropertyAttachments from "../../../component/PropertyAttachments";
...
const CommercialRetail = ({
  ...
  return (
    <>
      <div className="row">
        <GoogleMapAutoAddress address={data.address} setAddress={data.setAddress} latitude={data.latitude} setLatitude={data.setLatitude} longitude={data.longitude} setLongitude={data.setLongitude} addressList={addressList} setAddressList={setAddressList} radius={1 * METERS_PER_MILE} hideRadius={true} />
        <input
          type="hidden"
          name="latitude"
